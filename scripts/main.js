...
let addChMat = ()=>{
    addCh("js-chP","chapter 1","acumalaka acumalaka","js-ch1");
    ...
    /* CPP */
    addCh("cpp-chP","BAB Pendahuluan「 1 」","Penjelasan mengenai penemuan pemrograman Bahasa C++","cpp-ch1");
    addMateri("cpp-ch1","Sejarah C++","Awal Mula penemuan Bahasa Pemrograman C++","cpp-mat-1");
    addMateri("cpp-ch1","Tokoh-Tokoh Penemu C++","Tokoh Penemu Bahasa Pemrogran C++","cpp-mat-2");
